...
<nav class="navbar navbar-expand-md sticky-top" id="nav_color">
    <div class="container p-0">
        <div class="n_trans"> <a class="navbar-brand" id="logo_nav" href="#"><div><img id="logo" src="<?php echo asset('media/logo.png')?>" alt="" ></div></a></div>
        ...
        <div class="collapse navbar-collapse " id="navbarNavAltMarkup">
            <div class="navbar-nav " id="nav_inicio">
                <a id="items" class="nav-item nav-link" href="{{url('/animelist')}}"> <span class="mr-3">Inicio</span><i class="fas fa-home"></i></a>
                @if(Auth::user()->is_admin == true)
                <a id="items" class="nav-item nav-link  {{  Request::is('animelist/create') ? 'active' : ''}}"
                    href="{{url('/animelist/create')}}"> <span class="mr-3">Añadir anime</span><i class="fas fa-plus"></i></a>
                @endif
            </div>
